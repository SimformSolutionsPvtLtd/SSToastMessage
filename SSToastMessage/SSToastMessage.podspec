...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'AnkitPanchal10' => 'ankit.p@simformsolutions.com' }
  s.source           = { :git => 'https://github.com/AnkitPanchal10/SSToastMessage.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '13.0'

  s.source_files = 'SSToastMessage/Sources/Classes/**/*'
